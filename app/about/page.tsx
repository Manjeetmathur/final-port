    ...
    <PageLayout headings={headings}>
      ...
      <section id="education" className="space-y-4">
        ...
        <div className="space-y-4">
          <Card>
            <CardHeader>
              <CardTitle className="font-mono">BCA - Sarala Birla University</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="space-y-2">
                <p className="text-sm text-muted-foreground">
                  <span className="font-semibold text-foreground">Duration:</span> 2023 - 2026
                </p>
                <p className="text-sm text-muted-foreground">
                  <span className="font-semibold text-foreground">CGPA:</span> 9.5
                </p>
                <p className="text-sm text-muted-foreground mt-2">
                  Pursuing Bachelor of Computer Applications with focus on full-stack web development and software engineering.
                </p>
              </div>
            </CardContent>
          </Card>
          <Card>
            <CardHeader>
              <CardTitle className="font-mono">Class 12 - High School Tisri Barahmasiya</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="space-y-2">
                <p className="text-sm text-muted-foreground">
                  <span className="font-semibold text-foreground">Duration:</span> 2022 - 2023
                </p>
                <p className="text-sm text-muted-foreground">
                  <span className="font-semibold text-foreground">Marks:</span> 81%
                </p>
              </div>
            </CardContent>
          </Card>
